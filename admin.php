...
<div class="main">
    ...
    $pesanan_pending = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM transaksi WHERE status='pending'"));
    ?>
    ...
    <div class="cards">
        ...
        <div class="card">
            <h3>Total Stok</h3>
            <p><?php echo $stok['total'] ? $stok['total'] : 0; ?></p>
        </div>

        <div class="card" onclick="window.location='transaksi.php'" style="cursor: pointer; transition: 0.3s; border-left: 5px solid orange;">
            <h3>Pesanan Pending</h3>
            <p><?php echo $pesanan_pending; ?></p>
        </div>
